...
SELECT c.LastName, c.Firstname, c.Customer# FROM CUSTOMERS c, ORDERS o, ORDERITEMS i, BOOKS b WHERE c.Customer# = o.Customer# 
AND o.Order# = i.Order# AND i.ISBN = b.ISBN AND c.State = 'FL' AND b.Category = 'COMPUTER';

SELECT DISTINCT c.LastName, c.Firstname, b.Category FROM CUSTOMERS c, BOOKS b, ORDERS o, ORDERITEMS i WHERE c.Customer# = o.Customer# 
AND o.Order# = i.Order# AND i.ISBN = b.ISBN AND c.LastName = 'LUCAS' AND c.FirstName = 'JAKE';

SELECT c.LastName, c.FirstName, b.Title, i.PaidEach-b.Cost AS Paid FROM CUSTOMERS c JOIN ORDERS o USING (Customer#) JOIN ORDERITEMS i USING (Order#)
JOIN BOOKS b USING (ISBN) WHERE c.LastName = 'LUCAS' AND c.FirstName = 'JAKE' ORDER BY o.OrderDate, Paid DESC;
...
SELECT c.lastname, c.firstname, o.ShipDate FROM CUSTOMERS c, ORDERS o WHERE c.Customer# = o.Customer# AND o.ShipDate is NULL ORDER BY o.OrderDate;
...
SELECT BOOKS.Title, PUBLISHER.Contact, PUBLISHER.Phone FROM BOOKS, PUBLISHER WHERE BOOKS.PubID = PUBLISHER.PubID;
...
SELECT a.Lname, a.Fname, b.Title FROM AUTHOR a JOIN BOOKAUTHOR b USING (AuthorID) JOIN BOOKS b USING (ISBN) 
JOIN ORDERITEMS i USING (ISBN) JOIN ORDERS o USING (Order#) JOIN CUSTOMERS c USING (Customer#)
...
SELECT b.Title FROM BOOKS b JOIN BOOKAUTHOR c USING (ISBN) JOIN AUTHOR a USING (AuthorID) WHERE a.Lname = 'ADAMS'; 
 
SELECT b.Title, Order#, c.State FROM BOOKS b LEFT OUTER JOIN ORDERITEMS i USING (ISBN) LEFT OUTER JOIN ORDERS o USING (Order#)
...
SELECT ORDERS.Order#, ORDERITEMS.ISBN FROM ORDERS, ORDERITEMS WHERE ORDERS.Order# = ORDERITEMS.Order#; 

SELECT Order#, ISBN FROM ORDERS JOIN ORDERITEMS USING (Order#);

SELECT ORDERS.Order#, ORDERITEMS.ISBN FROM ORDERS JOIN ORDERITEMS ON ORDERS.Order# = ORDERITEMS.Order#;

SELECT ORDERS.Order#, ORDERITEMS.ISBN FROM ORDERS JOIN ORDERITEMS ON ORDERS.Order# = ORDERITEMS.Order# WHERE ORDERS.Order# BETWEEN 1001 AND 1005;

SELECT distinct ORDERS.Order#, ORDERITEMS.ISBN FROM ORDERS JOIN ORDERITEMS ON ORDERS.Order# = ORDERITEMS.Order# WHERE (ORDERS.Order# BETWEEN 1001 AND 1005) 
OR ORDERITEMS.ISBN = '3437212490';

SELECT BOOKS.ISBN, BOOKS.Cost, ORDERITEMS.Item#, BOOKAUTHOR.AuthorID FROM BOOKS, ORDERITEMS, BOOKAUTHOR 
WHERE BOOKS.ISBN = ORDERITEMS.ISBN AND ORDERITEMS.ISBN=BOOKAUTHOR.ISBN;

SELECT ISBN, Cost, Item#, AuthorID FROM BOOKS JOIN ORDERITEMS USING (ISBN) JOIN BOOKAUTHOR USING (ISBN);

SELECT BOOKS.ISBN, BOOKS.Cost, ORDERITEMS.Item#, BOOKAUTHOR.AuthorID 
FROM BOOKS JOIN ORDERITEMS ON BOOKS.ISBN = ORDERITEMS.ISBN JOIN BOOKAUTHOR ON ORDERITEMS.ISBN = BOOKAUTHOR.ISBN;

SELECT Lname FROM AUTHOR UNION SELECT LastName FROM CUSTOMERS;

SELECT Lname FROM AUTHOR UNION ALL SELECT LastName FROM CUSTOMERS;

SELECT Lname FROM AUTHOR INTERSECT SELECT LastName FROM CUSTOMERS;

SELECT Lname FROM AUTHOR MINUS SELECT LastName FROM CUSTOMERS;

SELECT BOOKAUTHOR.ISBN, BOOKS.Title, AUTHOR.AuthorID, AUTHOR.Lname FROM BOOKS, AUTHOR, BOOKAUTHOR 
...
SELECT p.Gift FROM PROMOTION p, BOOKS b WHERE b.Title = 'SHORTEST POEMS' AND b.Retail BETWEEN p.Minretail AND p.Maxretail; 
...
SELECT e.LNAME ||', '|| e.FNAME "Employees Name", E.JOB, m.LNAME ||', '|| m.FNAME "Managers Name" 
FROM EMPLOYEES e left OUTER JOIN EMPLOYEES m ON m.EMPNO = e.MGR ORDER BY "Managers Name";
