...
SELECT Order#, ShipDate FROM ORDERS WHERE ShipDate > '01-APR-2009';

SELECT Order#, OrderDate FROM Orders WHERE OrderDate < '01-APR-2009' OR OrderDate = '01-APR-2009';

SELECT Order#, OrderDate FROM Orders WHERE OrderDate <= '01-APR-2009' ;

SELECT ROUND(AVG(ShipCost),2), MAX(ShipCost), MIN(ShipCost) FROM ORDERS;

SELECT COUNT(ShipDate) FROM ORDERS;

SELECT COUNT(*) FROM ORDERS;

SELECT COUNT(ShipState), ShipState FROM ORDERS WHERE ShipDate IS NOT NULL GROUP BY ShipState HAVING COUNT(ShipState) >1;
...
SELECT Cost, Retail, GROUPING(Cost), GROUPING(Retail) FROM BOOKS GROUP BY CUBE (Cost, Retail);

SELECT Cost, Retail, AVG(Retail) FROM BOOKS GROUP BY ROLLUP (Cost, Retail);
...
SELECT Title, Category FROM Books WHERE Category LIKE 'C%N' OR Category LIKE 'C%G';

Select Title, Category from Books where Category IN('CHILDREN','COOKING');

SELECT ISBN, Title FROM Books WHERE Title LIKE '_A_N%' ORDER BY Title DESC;

SELECT Title, PubDate FROM Books WHERE Category = 'COMPUTER' AND (PubDate BETWEEN '01-JAN-05' AND '31-DEC-05');

SELECT Title, PubDate FROM Books WHERE Category = 'COMPUTER' AND (PubDate >= '01-JAN-05' AND PubDate <= '31-DEC-05');
